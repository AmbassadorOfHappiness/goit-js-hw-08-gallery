...
const addGallery = galleryItems.map(item => createGallery(item)).join('');
refs.gallery.insertAdjacentHTML('afterbegin', addGallery);

refs.gallery.addEventListener('click', modalOpen);
refs.closeBtn.addEventListener('click', modalClose);
refs.lightboxOverlay.addEventListener('click', modalCloseOverlay);
